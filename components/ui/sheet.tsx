  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-4 border shadow-lg transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in",
          side === "right" &&
          ...
          side === "bottom" &&
            "inset-x-0 bottom-0 h-auto max-h-[82vh] rounded-t-xl border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
          className
        )}
        {...props}
      >
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="sheet-footer" className={cn("mt-auto flex items-center justify-end gap-2 p-6", className)} {...props} />;
}
