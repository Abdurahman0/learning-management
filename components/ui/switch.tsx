  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-5 rounded-full bg-white ring-0 shadow-sm transition-transform data-[state=checked]:translate-x-[20px] data-[state=unchecked]:translate-x-0"
      />
    </SwitchPrimitive.Root>
  );
}
