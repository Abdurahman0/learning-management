...
export function AuthMarketing({ mode }: AuthMarketingProps) {
    ...
    return (
      <div className="min-w-0 space-y-6">
        <div className="space-y-3">
          <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">{t("signinMarketing.title")}</h1>
          <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">{t("signinMarketing.description")}</p>
        </div>
  ...
  return (
    <div className="min-w-0 space-y-7">
      <div className="space-y-3">
        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">{t("signupMarketing.title")}</h1>
        <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">{t("signupMarketing.description")}</p>
      </div>
