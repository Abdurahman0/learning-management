...
export function UnlockMoreCard() {
  ...
  return (
    <Card className="border-dashed border-border bg-card/90 py-0 shadow-sm">
      <CardContent className="px-4 py-6 text-center sm:px-6">
        <h3 className="text-xl font-semibold text-foreground">{t("listening.upgradeTitle")}</h3>
        <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-muted-foreground">{t("listening.upgradeDesc")}</p>
