...
type ListeningTypePerformanceProps = {
  items: ListeningTypePerformance[];
};
...
export function ListeningTypePerformance({ items }: ListeningTypePerformanceProps) {
  ...
  return (
    <Card className="gap-4 rounded-3xl border-slate-200/85 bg-white/95 p-4 shadow-sm shadow-slate-200/50 dark:border-border/75 dark:bg-card/75 dark:shadow-none sm:p-5">
      <div className="space-y-1">
        <p className="text-[11px] tracking-[0.16em] text-muted-foreground uppercase">{t("performanceByTypeEyebrow")}</p>
