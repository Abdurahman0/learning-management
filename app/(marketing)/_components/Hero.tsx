				...
				<div className='grid items-center gap-10 lg:grid-cols-2 lg:gap-12'>
					<div>
						...
						<h1 className='max-w-xl text-4xl leading-[1.05] font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-[62px]'>
							Train Like the Real Exam. Improve Like a Pro.{' '}
						...
						<p className='mt-6 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg'>
							Want a higher IELTS score? You don’t need endless practice — you
							need smart practice. On this platform, you work with real
							exam-style tasks and get clear feedback powered by AI, so you
							always know what to improve.
						</p>
						...
						<div className='mt-8 flex items-center gap-4'>
							<div className='flex -space-x-2'>
								<Avatar className='size-8 border-2 border-card'>
									<AvatarFallback className='bg-amber-200 text-[10px] font-semibold text-amber-900'>
										AN
									</AvatarFallback>
								</Avatar>
								<Avatar className='size-8 border-2 border-card'>
									<AvatarFallback className='bg-emerald-200 text-[10px] font-semibold text-emerald-900'>
										LU
									</AvatarFallback>
								</Avatar>
								<Avatar className='size-8 border-2 border-card'>
									<AvatarFallback className='bg-sky-200 text-[10px] font-semibold text-sky-900'>
										MO
									</AvatarFallback>
								</Avatar>
							</div>
							<p className='text-sm text-muted-foreground'>
								Joined by 10,000+ students this month
							</p>
						</div>
					</div>
					...
					<Card className='overflow-hidden border-border bg-linear-to-br from-emerald-300 via-teal-500 to-cyan-700 p-0 shadow-sm dark:shadow-black/20'>
						<div className='relative flex min-h-70 items-center justify-center sm:min-h-90'>
							...
							<span className='absolute top-[58%] text-lg font-semibold text-white drop-shadow-sm'>
								Watch Demo
							</span>
