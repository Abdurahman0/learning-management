    ...
    <section className="bg-background py-16 sm:py-20">
      <Container>
        <div className="grid items-start gap-10 lg:grid-cols-[1fr_1.35fr]">
          <div>
            <h2 className="max-w-sm text-4xl leading-tight font-bold text-foreground">Why prepare with this platform?</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {features.map((feature) => (
              <Card key={feature.title} className="hover:scale-105 transition duration-300 border-border bg-card py-0 shadow-sm">
