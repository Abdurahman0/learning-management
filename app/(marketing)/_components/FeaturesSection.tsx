    ...
    <section id="features" className="scroll-mt-24 bg-white py-16 sm:py-20">
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">Features</h2>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {features.map((feature) => (
            <Card key={feature.title} className="border-slate-200 bg-slate-50/80 py-0 shadow-sm hover:scale-105 transition duration-300">
        ...
        <Card className="mt-6 border-dashed border-slate-300 bg-slate-50 py-0">
