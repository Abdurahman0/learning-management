...
const VARIANT_SEEDS: VariantSeed[] = [
  {
    ...
    name: "Variant Set A",
    status: "used",
    questionTypesSummary: "TFNG (5) + Matching Headings (7)",
    questionTypeKeys: ["tfng", "matching_headings"],
    questionSignature: "urban-vA-tfng5-mh7",
  ...
  },
  {
    ...
    name: "Variant Set B",
    status: "draft",
    questionTypesSummary: "Multiple Choice (4) + Summary Completion (6)",
    questionTypeKeys: ["multiple_choice", "summary_completion"],
    questionSignature: "urban-vB-mcq4-sc6",
    usedInTestIds: [],
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "used",
    questionTypesSummary: "Matching Information (6) + TFNG (7)",
    questionTypeKeys: ["matching_information", "tfng"],
    questionSignature: "behavioral-vA-mi6-tfng7",
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "published",
    questionTypesSummary: "Summary Completion (5) + Short Answer (5)",
    questionTypeKeys: ["summary_completion", "short_answer"],
    questionSignature: "manufacturing-vA-sc5-sa5",
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "draft",
    questionTypesSummary: "Table Completion (6) + TFNG (4)",
    questionTypeKeys: ["table_completion", "tfng"],
    questionSignature: "volcanic-vA-tc6-tfng4",
    usedInTestIds: [],
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "used",
    questionTypesSummary: "Form Completion (10)",
    questionTypeKeys: ["form_completion"],
    questionSignature: "campus-vA-fc10",
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "used",
    questionTypesSummary: "Summary Completion (5) + MCQ (5)",
    questionTypeKeys: ["summary_completion", "multiple_choice"],
    questionSignature: "urban-talk-vA-sc5-mcq5",
  ...
  },
  {
    ...
    name: "Variant Set B",
    status: "published",
    questionTypesSummary: "Diagram Labeling (5) + Note Completion (5)",
    questionTypeKeys: ["diagram_labeling", "note_completion"],
    questionSignature: "urban-talk-vB-dl5-nc5",
    usedInTestIds: [],
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "published",
    questionTypesSummary: "Matching Information (5) + MCQ (5)",
    questionTypeKeys: ["matching_information", "multiple_choice"],
    questionSignature: "seminar-vA-mi5-mcq5",
  ...
  },
  {
    ...
    name: "Variant Set A",
    status: "used",
    questionTypesSummary: "Note Completion (6) + Short Answer (4)",
    questionTypeKeys: ["note_completion", "short_answer"],
    questionSignature: "tech-vA-nc6-sa4",
...
export const PASSAGE_ASSET_ENTITIES: PassageAssetEntity[] = PASSAGE_SEEDS.map((seed) => {
...
export const QUESTION_VARIANT_SET_ENTITIES: QuestionVariantSetEntity[] = VARIANT_SEEDS.map((seed) => {
  ...
  return {
    ...
    name: seed.name,
    status: seed.status,
    questionTypesSummary: seed.questionTypesSummary,
    questionTypeKeys: seed.questionTypeKeys,
    questionSignature: seed.questionSignature,
    usedInTestIds,
    createdAt: seed.createdAt
  }
})
